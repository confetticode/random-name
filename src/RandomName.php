...
namespace ConfettiCode\RandomName;
...
class RandomName
{
    ...
    {
        $person = $this->data['people'][rand(0, count($this->data['people']) - 1)];
        $adjective = $this->data['adjectives'][rand(0, count($this->data['adjectives']) - 1)];

        $name = $person . '-' . $adjective;
